...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/contrato.css" />" />
...
function addRow() {
    ...
    jq("#grid").jqGrid('editGridRow','new', {
    	url: "addContrato", 
     	editData: {},
       	...
       	afterShowForm: function(form) {
       		...
       		/*
       		$("#editmodgrid").delay(500).queue(function (next) { 
       	    	$(this).css({width:"auto"}); 
       	    	next(); 
       	 	});
       		*/
    	...
    	beforeSubmit: function(postdata, formid){
	    	if ( rtrim(ltrim($("#descricao").val())) == "" ) {
	    		genericMessage("Informe o contrato.", "Erro");
	    		return false;
	    	}
	...
	if( row != null ) 
		jq("#grid").jqGrid('editGridRow', row, { 
	        ...
	        afterShowForm: function(form) {
	       		...
	       		/*
	       		$("#editmodgrid").delay(800).queue(function (next) { 
	       	    	$(this).css({width:"auto"}); 
	       	    	next(); 
	       	 	});
	       		*/
